...
import com.test.gcp.exception.FileWriteException;
import com.test.gcp.exception.GCPFileUploadException;
import com.test.gcp.exception.InvalidFileTypeException;
...
public class DataBucketUtil {
    ...
    public FileDto uploadFile(MultipartFile multipartFile, String fileName, String contentType, RequestFileDto reqFileDto) {
        ...
        try{
            ...
            String id = "12345";
            Blob blob = bucket.create(reqFileDto.getEmail() + "/" + fileName + "-" + id + checkFileExtension(fileName), fileData, contentType);
    ...
    private String checkFileExtension(String fileName) {
        if(fileName != null && fileName.contains(".")){
            String[] extensionList = {".png", ".jpeg", ".pdf", ".bmp", ".mp3", ".jpg"};
